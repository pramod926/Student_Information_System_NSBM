...
public class Dashboard extends javax.swing.JFrame {
    ...
    String courseSql  = "SELECT COUNT(*) AS total FROM courses";
    String examSql    = "SELECT COUNT(*) AS total FROM exam_results";
    ...
    try (Connection con = DBConnection.getConnection()) {
        ...
        try (PreparedStatement pst = con.prepareStatement(studentSql);
            ...
            if (rs.next()) {
                ...
                jLabel4.setText(String.valueOf(totalStudents));
            }
        }

        // --- COUNT COURSES ---
        try (PreparedStatement pst = con.prepareStatement(courseSql);
             ResultSet rs = pst.executeQuery()) {

            if (rs.next()) {
                int totalCourses = rs.getInt("total");
                jLabel8.setText(String.valueOf(totalCourses));
            }
        }

        // --- COUNT EXAMS ---
        try (PreparedStatement pst = con.prepareStatement(examSql);
             ResultSet rs = pst.executeQuery()) {

            if (rs.next()) {
                int totalExams = rs.getInt("total");
                jLabel6.setText(String.valueOf(totalExams));
            }
        }

    } catch (Exception e) {
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, "Error loading counts: " + e.getMessage());
    }
}
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(10, 183, 186));

        jLabel1.setFont(new java.awt.Font("Script MT Bold", 1, 42)); // NOI18N
        ...
        jButton5.setForeground(new java.awt.Color(10, 183, 186));
        jButton5.setText("Student ID Genarate");
        ...
        jButton6.setForeground(new java.awt.Color(10, 183, 186));
        ...
        jPanel4.setBackground(new java.awt.Color(10, 183, 186));
        ...
        jLabel6.setFont(new java.awt.Font("Segoe UI", 3, 60)); // NOI18N
        ...
        jPanel5.setBackground(new java.awt.Color(10, 183, 186));
        ...
        jLabel8.setFont(new java.awt.Font("Segoe UI", 3, 60)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Exam_Dashboard exmdashboard = new Exam_Dashboard();
        exmdashboard.setVisible(true);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Genarate_Student_ID genStudentID = new Genarate_Student_ID();
        genStudentID.setVisible(true);
